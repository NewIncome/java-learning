...
public class Proj2_MadLibsClone {
    public static void main(String[] args) {
        ...
        System.out.print("She loved to wear " + clothing + " and to " + hobby + ". She wanted to marry the " + adjective3 + " " + occupation2 + " named " + boysName + " but her father, King " + mansName + " forbid her from seeing him.");
    }//end main
}
