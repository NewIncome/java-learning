...
/**
 * Given a non-empty integer array arr[]. Your task is to find and return the
...
public class TopKFrequentInArray {
  ...
  public static void main(String[] args) {
    System.out.println(topKFreq(Arrays.asList(3,1,4,4,5,2,6,1), 2));
    System.out.println(topKFreq(Arrays.asList(7,10,11,5,2,5,5,7,11,8,9), 4));
  }//end main
